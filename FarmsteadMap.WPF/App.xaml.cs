        ...
        public App()
        {
            AppHost = Host.CreateDefaultBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    // Логування
                    string logPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "farmstead_log.txt");
                    services.AddSingleton<ILoggerService>(provider => new SerilogLoggerService(logPath));

                    // --- РЕПОЗИТОРІЇ (DAL) ---
                    services.AddScoped<IUserRepository, UserRepository>();
                    services.AddScoped<IMapRepository, MapRepository>(); // Додано для роботи з мапами
                    ...
                    // Додані сервіси для редактора мап:
                    services.AddScoped<IMapService, MapService>();
                    services.AddScoped<IMapToolsService, MapToolsService>();
